    ...
    <?php else : ?>
        ...
        <div class="row">
            ...
            <div class="tab-content col-12">
                ...
                <nav aria-label="breadcrumb border-radius-xl" style="border-radius: 25px;">
                    <ol class="breadcrumb px-3 shadow-sm" style="border-radius: 15px">
                        ...
                        <li class="breadcrumb-item font-weight-bolder active" aria-current="page">Publications</li>
                    </ol>
                </nav>
                    ...
                    <div class="row">
                        ...
                        <?php if (is_array($nwsf_qry) || is_object($nwsf_qry)) : ?>
                            <?php foreach ($nwsf_qry as $key => $value) : ?>
                                ...
                                ?>
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3/ article_container mb-2" style="padding: 5px !important;">
                                    <div id="article_<?= $artcle_cnt ?>" class="media_div article_contents artclt_bg1" style="padding: 17px 5px; border-radius: 25px; ">

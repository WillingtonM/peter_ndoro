...
<div id="about_div" class="container pt-10 min-vh-100">
    ...
    <div class="page-header min-height-500 border-radius-xl/ mt-4 wait-2s" data-animation="animated pulse" style="border-radius: 35px;">
            ...
            <div class="p-0">
                <div class="text-center px-3 pt-5">
                    ...
                    <small class="m-0 text-light px-3">
                        ...
                        Ndoro began his broadcasting journey at ZBC Radio One in Zimbabwe before venturing to South Africa to further his career. <br>
                        In South Africa, he secured a voice-over position with M-Net, which marked the beginning of his television career. <br>
                        His captivating and soothing voice also gained recognition on popular radio stations such as Radio Highveld and SAFM. <br>
                        <br> 
                        In addition to his radio and television endeavors, Ndoro is in high demand as a master of ceremonies, demonstrating his exceptional skills in hosting events. <br>
                        Peter Ndoro's remarkable journey, international experience, and remarkable talents have solidified his status as a respected media personality, <br> 
                ...
                <div class="row px-3">
                        ...
                        <div class="animated bounceInLeft wait-1s" style="border-radius: 25px; padding-bottom: 15px;">
                            ...
                            <div class="card_work_about p-0">
                                <div class="text-center w-100 home_card p-0 abt-card">
                                    <p class="text-center p-3 text-white font-weight-bolder fs-3">Conference Speaker</p>
                                </div>
                                <div class="p-3">
                    ...
                    <div class="col-lg-4">
                        <div class="animated bounceInUp wait-1s" style="border-radius: 25px; padding-bottom: 15px;">
                            ...
                            <div class="card_work_about p-0">
                                <div class="text-center w-100 home_card p-0 abt-card">
                                    <p class="text-center p-3 text-white font-weight-bolder fs-3">Moderator</p>
                                </div>
                                <div class="p-3">
                    ...
                    <div class="col-lg-4">
                        <div class="animated bounceInRight wait-1s" style="border-radius: 25px; padding-bottom: 15px;">
                            ...
                            <div class="card_work_about p-0">
                                <div class="text-center w-100 home_card p-0 abt-card">
                                    <p class="text-center p-3 text-white font-weight-bolder fs-3">MC | <small> <i class="text-sm">Master of Ceremonies</i> </small> </p>
                                </div>
                                <div class="p-3">
                                    <p class="card-text/ text-light">

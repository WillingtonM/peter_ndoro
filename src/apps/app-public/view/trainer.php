<div id="services_div" class="container pt-10 min-vh-100">
        ...
        <span class="mask opacity-6/" style="background-color: rgb(41, 55, 75, .5);">
            <div class="p-0">
                <div class="text-center px-3 pt-5">
                    ...
                    <button type="button" class="btn btn-dark border-radius-lg me-3 border" style="border-radius: 12px;" onclick="requestModal(post_modal[9], post_modal[9], {'type':'trainer'})">Online Booking</button>
    ...
    <div class="mx-4 mt-n6">
        <div class="row">
            <?php $home_key = 'gallery' ?>
            <?php $home_val = $journalism_array[$home_key] ?>

            <div class="col-12 col-md-2 mb-3 wait-s" data-animation="animated">
            </div>
            <div style="z-index: 12;" class="col-12 col-md-8 mb-3 wait-<?= $home_val['wait'] ?>s" data-animation="animated <?= $home_val['anim'] ?>">
        ...
        <div class="row text-center mb-3 p-3">
            <?php if (is_array($tvap_qry) || is_object($tvap_qry)) : ?>
                ...
                <div class="col-12 text-center mt-3">
                    <a href="./media?tab=gallery" class="text-white btn btn-secondary px-3 py-1">View More Media Gallery</a>
                </div>
            <?php endif; ?>
        </div>
    </div>

        ...
        <span class="mask opacity-6/" style="background-color: rgb(41, 55, 75, .5);">
            <div class="p-0">
                <div class="text-center px-3 pt-5">
                    ...
                    <button type="button" class="btn btn-dark border-radius-lg me-3 border" style="border-radius: 12px;" onclick="requestModal(post_modal[9], post_modal[9], {'type':'mc'})">Online Booking</button>

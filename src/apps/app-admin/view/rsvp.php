        ...
        <div class="col-12 px-0">
            <div class="card mb-4">
                <div class="col-12 px-4 mt-3">
                    ...
                    <?php endif; ?>
                    <h3 class="float-end " style="font-size: 2.2em;"> <button class="btn btn-warning" onclick="requestModal(post_modal[9], post_modal[9], {})"> Add RSVP</button> </h3>
                </div>
                                    ...
                                    <?php foreach ($rsvp as $value) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a type="buttton" class="cursor-pointer" onclick="requestModal(post_modal[9], post_modal[9], {'event_id': <?= ((isset($value['event_id'])) ? $value['event_id'] : '') ?>})"> <i class="fas fa-edit text-dark me-2"></i> View </a>
                                            </td>
                                        </tr>

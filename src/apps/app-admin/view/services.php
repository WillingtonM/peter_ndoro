            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6> <span>Service Routes</span>
                        <a type="button" class="btn btn-dark float-end" onclick="requestModal(post_modal[13], post_modal[13], {})"> Add Route</a>
                    </h6>
                </div>
                                    ...
                                    <?php foreach ($services as $service) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="javascript:;" class="text-secondary font-weight-bold text-xs" onclick="requestModal(post_modal[13], post_modal[13], {'service':<?= $service['service_id'] ?>})">
                                                    Edit
                                                </a>
                                            </td>
                                        </tr>

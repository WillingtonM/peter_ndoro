        ...
        <div class="rounded-0/">
            <div class="col-12/ p-0">
                ...
                <div class="text-center py-2">
                    <h3 class="text_default" style="font-weight: bolder;"> Event Bookings </h3>
                    <small class="m-0 alt2_color" style="font-weight: 600; font-size:medium;"> You may Edit the event bookings </small>
                </div>
            </div>
            <br>

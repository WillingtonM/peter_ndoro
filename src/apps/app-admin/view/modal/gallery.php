...
<div class="row">
	...
	<div class="col-12 mt-4">
		<?php if (isset($media_res) && !empty($media_res)) : ?>
			<a type="button" class="btn btn-danger btn-sm shadow-none text-white float-end border-radius-lg" onclick="postonly(path_action, {'media_remove':true,'media_id':<?= $media_res['media_id'] ?>}, 'error_pop');"> Remove</a>
		<?php endif; ?>

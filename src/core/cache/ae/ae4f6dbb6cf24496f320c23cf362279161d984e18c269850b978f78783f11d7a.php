...
/* order_invoice.html */
class __TwigTemplate_6862fa37b7825ea80e6b81512d177874c98bdd41df4aac9646fcc497a4183cba extends Template
{
    private $source;
    private $macros = [];
  ...
  <body>
    ...
    <div id=\"container\" class=\"container invoice_pg\" style=\"background-color: #fff !important;\">
      <div class=\"row\">
        <div class=\"col-12\">
                    ...
                    <div class=\"row\">
                      <div class=\"col-12\">
                        <table class=\"table table-sm table-striped\">
                          ...
                          <tbody>
                            <tr>
                              <th style=\"font-size: .8rem\" scope=\"row\"><?= \$data['order_data']['order_id'] ?></th>
                              <td style=\"font-size: .8rem\"><?= \$data['order_date'] ?></td>
      ...
      <div class=\"row\">
        <div class=\"col-12\">
            ...
            <table id=\"cart_table_<?= \$merchant_id ?>\" class=\"table table-striped table-sm table-info/ table-borderless\">
              ...
              <tbody style=\"font-size: .9em;\">
                ...
                <?php if (is_array(\$cart_items) || is_object(\$cart_items)) : ?>
                  ...
                  <?php foreach (\$cart_items as \$cart_product => \$val) : ?>
                    <?php \$available = 0; ?>
                      ...
                      <?php if (isset(\$variation_qty) && !empty(\$variation_qty) && is_array(\$variation_qty)) : ?>
                        ...
                        <?php foreach (\$variation_qty as \$size_key => \$quantity) : ?>
                          ...
                          <tr id=\"cart_item<?= \$product_id ?>\" class=\"bg-info/\" style=\"color: #6b6b6b;\">
                            ...
                            <td>
                              <a class=\"text-secondary pointer\" onclick=\"requestModal(post_modal[2], 'productModal', {'product_id':<?= \$product['product_id'] ?>, 'merchant': '<?= \$merchant['merchant_name'] ?>', 'div_id':'alt_prod_cart<?= \$product['product_id'] ?>'});\" style=\"text-decoration/: none; color/: #6b6b6b; padding-top: 5px;\">
          ...
          <div class=\"col-12/\">
            ...
            <span>Total &nbsp; <b class=\"badge badge-secondary badge-pill\" style=\"font-size/: .9em;\"><?= money_currency(\$currency['currency_symbol'], \$grand_total); ?></b> </span>
      ...
      <div class=\"row invoice_btn\" style=\"display: none;\">
        <div class=\"col-12\">
          <br>
          <!-- <a type=\"button\" class=\"btn btn-sm btn-danger\" onclick=\"print_window()\" style=\"padding: 5px 25px; border-radius: 12px; color: #fff; font-weight: bold;\">Print Invoice</a> -->
          <a href=\"<?= ABS_INVOICES . \$data['user_data']['username'] . DS . 'invoice' . \$data['order_data']['order_id'] . '.pdf' ?>\" class=\"btn btn-sm btn-danger\" download=\"\" style=\"padding: 5px 25px; border-radius: 12px; color: #fff; font-weight: bolder;\">
            <i class=\"fad fa-file-download\"></i> &nbsp; Download Invoice
          </a>
          <br>
    ...
    {
        return new Source("", "order_invoice.html", "C:\\wamp64\\www\\picktick\\src\\core\\templates\\order_invoice.html");
    }
}

  ...
  <body>
      ...
      <div id="invoice_container" class="container invoice_pg" style="padding: 15px; padding-bottom: 35px; border-radius: 15px;">
              ...
              <div class="col-12">
                  <div style="padding-bottom: 12px; padding-top: 5px; border-bottom: 5px solid #D1ECF1; width: 100%;">
                      <h3 style="position: relative; ">
                          ...
                          <span style="position: absolute; padding-left: 9px; top: 5px; font-size: 2.2rem; color:#767676"><b style="padding-top: 15px;">{{ project_title }}</b></span>
                      </h3>
                  </div>
              </div>
          </div>
          ...
          <div class="row">
              <div class="col-12">
                  <br><br>
                  <div style="border-radius: 15px; padding-top: 0px;">
                              ...
                              <tr>
                                  <td style="width: 50%; padding-right: 9px;">
                                          ...
                                          <div class="col-12">
                                              <div class="" style="border-radius: 9px; border-top: none !important; padding-top: 5px">
                                                  <table class="table table-sm table-striped table-info" style="color: #767676; padding-bottom: 0;">
                                                      ...
                                                      <tbody>
                                                          <tr>
                                                              <th style="font-size: .8rem" scope="row">{{ order_id }}</th>
                                      ...
                                      <p style="color: #767676;">
                                          This receipt is to confirm your billing of your <b>{{ order_item }} Subscription</b> plan on <b>{{ order_date }}</b>.
                                      </p>

                                  </td>

                                  <td style="padding: 0 9px; color: #767676; border-radius: 15px;" class="table-active/ alert/ alert-info">
                                      <div style="padding-top: 15px; border-bottom: 1px solid #17A2B8;">
                                          <div style="padding-bottom: 7px;">
                                              <!-- <img src="data:{# merchant_logo #}" style="top: 0; width: 3rem; height: 3rem; border-radius: 30%; padding: 2px; border: 1px solid #ddd;" alt=""> -->
                                              <span style="font-size: 1.3rem; color:#767676"><b style="padding-top: 15px;">{{ merchant_data.merchant_display_name }}</b>@{{ merchant_data.merchant_name }}</span>
                                          </div>
                                      </div>
                  ...
                  <div style="border-radius: 15px; border: 1px solid #eaeaea;">
                      ...
                      <table class="table table-striped table-borderless" style=" color: #767676; font-size: 1.2rem">
                          <thead class="thead-dark/" style="font-size: .9em">
                              <th style="font-weight: bolder !important;">Subscription Type</th>
                              <th class="float-right" style="font-weight: bolder !important;">{{ order_item }} Plan</th>
                          </thead>
                          <tbody style="font-size: .9em;">

                              <tr style="color: #6b6b6b;">
                                  <td> Monthly Subscription Amount </td>

                                  <td class="float-right"> <span style="font-weight: bolder; font-size: 1rem;"> {{ currency_price }} </span> </td>
                              </tr>
          ...
          <div class="col-12" style="font-size: 1.5rem;">
              <span style="font-weight: bold;"># Items &nbsp; <b class="badge badge-info badge-pill"> 1 </b></span> &emsp;

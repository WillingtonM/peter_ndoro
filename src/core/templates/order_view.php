 ...
 */
    ...
    .article_nav.article_active span {
        color: #eee !important;
    }

    .article_nav.article_active {
        background-image: linear-gradient(310deg, #141727 0%, #3A416F 0%) !important;
        /* background: rgb(85, 85, 85, .9) !important; */
        color: #eee !important;
        border: 1px solid #777;
        box-shadow: 0px 0px 7px 1px #929294;
    }

    .article_nav.article_active .sm_text {
        color: #eee !important;
    }

    .article_nav a.active {
        color: #7c7470 !important;
...
<div id="invoice_container" class="container invoice_pg" style="padding: 15px; padding-bottom: 35px; border-radius: 15px;">
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div style="border-bottom: 5px solid #ddd;">
                <div class="d-flex py-14 mt-2 col-12">
                    <div>
                        <img src="data:{{ project_logo }}" class="avatar avatar-lg me-3" alt="user1">
                    </div>
                    <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-xl/ text-secondary" style="font-size: 2em;">
                            <span class="font-weight-bolder"> <b style="color: #b90102;">Pick</b><b style="color: #03556b;">tick</b> </span>
                        </h6>
                    </div>
                </div>
            </div>
            <small class="float-end mt-2" style="font-weight: 600; font-size: .9rem; color:#767676;"> This is an automatically generated invoice </small>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 col-md-8">
                    ...
                    <div class="card mb-3">
                        <div class="card-header pb-0" style="border-bottom: 1px solid #ddd;">
                            <h1 class="text-dark mt-4"><span style="font-size: 5rem;">RECEIPT</span></h1>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="p-0">

                                <table id="all_products" class="table align-items-center table-striped mb-0 table-responsive" style="white-space:nowrap; width: 100%">
                                    <thead>
                                        <tr>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center" style="width: .1%; white-space: nowrap;"> Invoice #</th>
                                    ...
                                    <tbody class="table_body">
                                        <tr class="text-secondary">
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <p class="p-0 m-0"> {{ order_data.order_id }} </p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <p class="p-0 m-0"> {{ order_date }} </p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <p class="p-0 m-0"> {{ currency_price }} </p>
                                            </td>
                        ...
                        <div class="footer">
                            <p class="p-3" style="color: #767676;">
                                This this receipt is to confirm that {{ user_data.name }} {{ user_data.last_name }} has purchased the following item(s) from {{ merchant_data.merchant_display_name }} on {{ order_date }}.
                            </p>
                        </div>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <div style="padding: 0 9px; color: #767676; border-radius: 15px;" class="bg-dark shadow">

                            <div class="d-flex py-14 mt-2 pt-2">
                                <div>
                                    <img src="data:{{ merchant_logo }}" class="avatar avatar-sm me-3" alt="user1">
                                </div>
                                <div class="d-flex flex-column justify-content-center">
                                    <h6 class="mb-0 text-sm text-light">
                                        <span class="font-weight-bolder">{{ merchant_data.merchant_display_name }}</span>
                                    </h6>
                                    <p class="text-xs text-light mb-0"> @{{ merchant_data.merchant_name }} </p>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    <h6 class="bold text-light mt-2">MERCHANT</h6>
                                    <div class="col" style="color: #aaa;">
                                        <p class="mb-0"> {{ merchant_address.line_1 }} </p>
                                        <p class="mb-0"> {{ merchant_address.city_town }} </p>
                                        <p class="mb-0"> {{ merchant_address.state }} </p>
                                        <p class="mb-3"> {{ merchant_address.country }} </p>
                                        <span class="mb-0"><b class="font-weight-bold"> {{ merchant_contact }} </b></span> &nbsp; <br>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12" style="padding-bottom: 9px;">
                                    <h6 class="bold text-light mb-3">CUSTOMER</h6>
                                    <div class="col" style="color: #aaa;">
                                        <p>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="p-0">
                        ...
                        <table id="all_products" class="table align-items-center table-striped mb-0 table-responsive" style="white-space:nowrap; width: 100%">
                            <thead>
                                <tr>
                                    <th class="text-uppercase font-weight-bolder text-center" style="width: .1%; white-space: nowrap;"> # </th>
                                    <th class="text-uppercase font-weight-bolder p-1"> product </th>
                                    <th class="text-uppercase font-weight-bolder text-center"> Size </th>
                                    <th class="text-uppercase font-weight-bolder text-center"> Quantity </th>
                                    <th class="text-uppercase font-weight-bolder text-center"> Price </th>
                                    <th class="text-uppercase font-weight-bolder text-center"> Total </th>
                                </tr>
                            </thead>
                            <tbody class="table_body">
                                ...
                                <tr class="text-secondary">
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <p class="p-0 m-0"> {{ product.currency_symbol }} {{ product.price }} </p>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <p class="p-0 m-0"> {{ product.currency_symbol }} {{ quantity * product.price }} </p>
                                    </td>
    ...
    <div class="row p-3 mb-5">
        <div class="col-12" style="font-size: 1.5rem;">
            <span style="font-weight: bold;"># Items &nbsp; <b class="badge rounded-pill bg-dark"> {{ item_count }} </b></span> &emsp;
            <span style="font-weight: bold;">Total &nbsp; <b class="badge rounded-pill bg-dark"> {{ currency_price }} </b> </span> &emsp;
            <span style="font-weight: bold;">Status &nbsp; <b class="badge rounded-pill bg-{{ order_alert }}"> {{ order_state }} </b> </span>
        </div>
    </div>
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="mb-0 mx-3 mb-0" style="border-bottom: 1px solid #ddd;">
                <p class="font-weight-bolder fs-4 text-uppercase"> Summary </p>
            </div>
            <div class="card mb-3">
                <div class="card-body px-0 pt-0 pb-2/">
                    <div class="px-3">
                        <table class="table align-items-center table-striped mb-0 table-responsive table-sm/ table-dark/" style="color:#767676;">
                            <thead>
                                <tr>
                                    <th class="text-uppercase font-weight-bolder" style="width: 20%; white-space: nowrap;"></th>
                                    <th class="text-uppercase font-weight-bolder"></th>
                                    <th class="text-uppercase font-weight-bolder pe-3"> <span class="float-end"> Amount </span> </th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="align-middle text-sm font-weight-bolder"> Payment Method</td>
                                    <td> {{ payment_method }} </td>
                                    <td class="pe-3"> <span class="float-end"> </span> </td>
                                </tr>
                                <tr>
                                    <td class="align-middle text-sm font-weight-bolder"> Delivery Method</td>
                                    <td> Collection </td>
                                    <td class="pe-3"> <span class="float-end"> {{ currency_symbol }} 0.00 </span> </td>
                                </tr>
                                <tr>
                                    <td class="align-middle text-sm font-weight-bolder"> Total Items </td>
                                    <td> {{ item_count }} </td>
                                    <td class="pe-3"> <span class="float-end"> - </span> </td>
                                </tr>
                                <!-- <tr>
                                    <td class="align-middle text-sm font-weight-bolder">Tax (15%)</td>
                                    <td></td>
                                    <td class="pe-3"> <span class="float-end"> </span> </td>
                                </tr> -->
                                <tr>
                                    <td class="align-middle text-sm font-weight-bolder">Net Total </td>
                                    <td></td>
                                    <td class="pe-3"> <span class="float-end font-weight-bolder"> {{ currency_price }} </span> </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>

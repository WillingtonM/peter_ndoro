...
<div class="row form-row align-items-center">
    <div class="col-12 col-lg-6/ mb-3">
        ...
        <div class="input-group mb-2">
            <span class="input-group-text bg-light text-dark" style="border-right: none;"><i class="fa-regular fa-clipboard input_color"></i></span>
...
<div class="row">
    ...
    <div class="col-12 mb-3">
        ...
        <select id="event_period" class="form-control shadow-none bg-light" name="event_period">
            ...
            <option value="half_day" <?= ((isset($event['event_period']) && $event['event_period'] == 'half_day') ? 'selected' : '') ?>> Half day (1 Hour)</option>
            <option value="half_day" <?= ((isset($event['event_period']) && $event['event_period'] == 'half_day') ? 'selected' : '') ?>> Half day (1 - 3 Hours)</option>
            <option value="extended_day" <?= ((isset($event['event_period']) && $event['event_period'] == 'extended_day') ? 'selected' : '') ?>> Full day (3 - 6 Hours)</option>
        </select>
    </div>
